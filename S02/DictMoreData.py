...
accountsInfoList = [{'name': 'Mike', 'balance': 100,
                     'stockList': ['600123', '600158']}, {
    'name': 'Tom', 'balance': 200, 'stockList': ['600243', '600558']}]
# 通过for循环，依次输出列表中的元素
...
# 以字典的方式
accountInfoDict = {'Peter': {'balance': 100, 'stockList':
                             ['600123', '600158']},
                   'Tom': {'balance': 200, 'stockList': ['600243', '600558']}}
# 输出{'balance': 100, 'stockList': ['600123', '600158']}
print(accountInfoDict.get('Peter'))
PeterAccount = {'Peter': {'balance': 200, 'stockList':
                          ['600223', '600158', '600458']}}
